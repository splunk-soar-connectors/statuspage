...
This table lists the configuration variables required to operate Statuspage. These variables are specified when configuring a Statuspage asset in Splunk SOAR.
